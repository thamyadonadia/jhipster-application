...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.library.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.library.security.DomainUserDetailsService", "createSpringSecurityUser");
